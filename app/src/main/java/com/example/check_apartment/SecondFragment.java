...
import com.example.check_apartment.databinding.FragmentSecondBinding;
import com.example.check_apartment.presenter.IViewScore;
import com.example.check_apartment.presenter.PresenterScore;
...
public class SecondFragment extends Fragment implements IViewScore {
    ...
    private String imagen, nombre, depto, totalSt ;
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        mBinding.rgEstTern.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                int estado =mBinding.rgEstTern.indexOfChild(mBinding.rgEstTern.
        ...
        mBinding.btAlert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mIntent.putExtra(Intent.EXTRA_TEXT,
                        "Revisión de departamento " + nombre + " " + depto);
        ...
        mBinding.btSave.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(getContext(), "Puntaje obtenido " + totalSt,
                        Toast.LENGTH_SHORT).show();
            }
        });
